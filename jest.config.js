...
module.exports = {
  ...
  // Se mantiene el reporte normal de Jest y se agrega un reporte HTML
  // para consultar de forma visual las suites, resultados y tiempos.
  reporters: [
    'default',
    [
      'jest-stare',
      {
        ...
        reportTitle: 'Reporte de pruebas - Task Manager',
        reportHeadline: 'Resultado de la ejecución automatizada',
        reportSummary: true,
